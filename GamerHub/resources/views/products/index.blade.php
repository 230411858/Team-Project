    ...
    <section class="layout">
      <div class="feed">
        ...
        <a href="{{ url('/products/category/microphones') }}" class="type_card">
            <p class="type_card__category">Microphones</p>
            <p class="type_card__title">Little description</p>
          </a>
        <a href="{{ url('/products/category/speakers') }}" class="type_card">
            <p class="type_card__category">Speakers</p>
            <p class="type_card__title">Little description</p>
          </a>
        <a href="{{ url('/products/category/monitors') }}" class="type_card">
            <p class="type_card__category">Keyboards</p>
            <p class="type_card__title">Little description</p>
          </a>
        <a href="{{ url('/products/category/mice') }}" class="type_card">
            <p class="type_card__category">Mice</p>
            <p class="type_card__title">Little description</p>
          </a>
        <a href="{{ url('/deals') }}" class="type_card">
            <p class="type_card__category">Discounted</p>
            <p class="type_card__title">Little description</p>
          </a>
    </section>
@endsection
